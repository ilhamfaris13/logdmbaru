...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "newrm_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "andrologi", "varname" => "newrm_at_localhost__andrologi", "altvarname" => "andrologi", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "bedah", "varname" => "newrm_at_localhost__bedah", "altvarname" => "bedah", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "catatan_kemajuan", "varname" => "newrm_at_localhost__catatan_kemajuan", "altvarname" => "catatan_kemajuan", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "daftar_masalah", "varname" => "newrm_at_localhost__daftar_masalah", "altvarname" => "daftar_masalah", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "daftar_masalah_interna", "varname" => "newrm_at_localhost__daftar_masalah_interna", "altvarname" => "daftar_masalah_interna", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "daftar_masalah_pediatri", "varname" => "newrm_at_localhost__daftar_masalah_pediatri", "altvarname" => "daftar_masalah_pediatri", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "dosen", "varname" => "newrm_at_localhost__dosen", "altvarname" => "dosen", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "ginekologi", "varname" => "newrm_at_localhost__ginekologi", "altvarname" => "ginekologi", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "icd10", "varname" => "newrm_at_localhost__icd10", "altvarname" => "icd10", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "identitas_pasien", "varname" => "newrm_at_localhost__identitas_pasien", "altvarname" => "identitas_pasien", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "interna", "varname" => "newrm_at_localhost__interna", "altvarname" => "interna", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "jiwa", "varname" => "newrm_at_localhost__jiwa", "altvarname" => "jiwa", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "kulit", "varname" => "newrm_at_localhost__kulit", "altvarname" => "kulit", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "mata", "varname" => "newrm_at_localhost__mata", "altvarname" => "mata", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "neurologi", "varname" => "newrm_at_localhost__neurologi", "altvarname" => "neurologi", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "obstetri", "varname" => "newrm_at_localhost__obstetri", "altvarname" => "obstetri", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "paru", "varname" => "newrm_at_localhost__paru", "altvarname" => "paru", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "pediatri", "varname" => "newrm_at_localhost__pediatri", "altvarname" => "pediatri", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "rencana_permulaan", "varname" => "newrm_at_localhost__rencana_permulaan", "altvarname" => "rencana_permulaan", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "resep", "varname" => "newrm_at_localhost__resep", "altvarname" => "resep", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "resep_kacamata", "varname" => "newrm_at_localhost__resep_kacamata", "altvarname" => "resep_kacamata", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "rujukan", "varname" => "newrm_at_localhost__rujukan", "altvarname" => "rujukan", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "tht", "varname" => "newrm_at_localhost__tht", "altvarname" => "tht", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "newrm_at_localhost__users", "altvarname" => "users", "connId" => "newrm_at_localhost", "schema" => "", "connName" => "newrm2 at localhost");
		}
	}
