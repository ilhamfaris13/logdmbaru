...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "andrologi" ] = array( "url" => "andrologi", "type" => 0 );
	$projectEntitiesReverse[ "andrologi" ] = "andrologi";
	$projectEntities[ "mata" ] = array( "url" => "mata", "type" => 0 );
	$projectEntitiesReverse[ "mata" ] = "mata";
	$projectEntities[ "identitas_pasien" ] = array( "url" => "identitas_pasien", "type" => 0 );
	$projectEntitiesReverse[ "identitas_pasien" ] = "identitas_pasien";
	$projectEntities[ "icd10" ] = array( "url" => "icd10", "type" => 0 );
	$projectEntitiesReverse[ "icd10" ] = "icd10";
	$projectEntities[ "users" ] = array( "url" => "users", "type" => 0 );
	$projectEntitiesReverse[ "users" ] = "users";
	$projectEntities[ "jiwa" ] = array( "url" => "jiwa", "type" => 0 );
	$projectEntitiesReverse[ "jiwa" ] = "jiwa";
	$projectEntities[ "tht" ] = array( "url" => "tht", "type" => 0 );
	$projectEntitiesReverse[ "tht" ] = "tht";
	$projectEntities[ "rujukan" ] = array( "url" => "rujukan", "type" => 0 );
	$projectEntitiesReverse[ "rujukan" ] = "rujukan";
	$projectEntities[ "resep" ] = array( "url" => "resep", "type" => 0 );
	$projectEntitiesReverse[ "resep" ] = "resep";
	$projectEntities[ "ginekologi" ] = array( "url" => "ginekologi", "type" => 0 );
	$projectEntitiesReverse[ "ginekologi" ] = "ginekologi";
	$projectEntities[ "interna" ] = array( "url" => "interna", "type" => 0 );
	$projectEntitiesReverse[ "interna" ] = "interna";
	$projectEntities[ "kulit" ] = array( "url" => "kulit", "type" => 0 );
	$projectEntitiesReverse[ "kulit" ] = "kulit";
	$projectEntities[ "pediatri" ] = array( "url" => "pediatri", "type" => 0 );
	$projectEntitiesReverse[ "pediatri" ] = "pediatri";
	$projectEntities[ "resep_kacamata" ] = array( "url" => "resep_kacamata", "type" => 0 );
	$projectEntitiesReverse[ "resep_kacamata" ] = "resep_kacamata";
	$projectEntities[ "dosen" ] = array( "url" => "dosen", "type" => 0 );
	$projectEntitiesReverse[ "dosen" ] = "dosen";
	$projectEntities[ "catatan_kemajuan" ] = array( "url" => "catatan_kemajuan", "type" => 0 );
	$projectEntitiesReverse[ "catatan_kemajuan" ] = "catatan_kemajuan";
	$projectEntities[ "daftar_masalah" ] = array( "url" => "daftar_masalah", "type" => 0 );
	$projectEntitiesReverse[ "daftar_masalah" ] = "daftar_masalah";
	$projectEntities[ "daftar_masalah_interna" ] = array( "url" => "daftar_masalah_interna", "type" => 0 );
	$projectEntitiesReverse[ "daftar_masalah_interna" ] = "daftar_masalah_interna";
	$projectEntities[ "daftar_masalah_pediatri" ] = array( "url" => "daftar_masalah_pediatri", "type" => 0 );
	$projectEntitiesReverse[ "daftar_masalah_pediatri" ] = "daftar_masalah_pediatri";
	$projectEntities[ "rencana_permulaan" ] = array( "url" => "rencana_permulaan", "type" => 0 );
	$projectEntitiesReverse[ "rencana_permulaan" ] = "rencana_permulaan";
	$projectEntities[ "mata1" ] = array( "url" => "mata1", "type" => 1 );
	$projectEntitiesReverse[ "mata1" ] = "mata1";
	$projectEntities[ "paru" ] = array( "url" => "paru", "type" => 0 );
	$projectEntitiesReverse[ "paru" ] = "paru";
	$projectEntities[ "obstetri" ] = array( "url" => "obstetri", "type" => 0 );
	$projectEntitiesReverse[ "obstetri" ] = "obstetri";
	$projectEntities[ "bedah" ] = array( "url" => "bedah", "type" => 0 );
	$projectEntitiesReverse[ "bedah" ] = "bedah";
	$projectEntities[ "neurologi" ] = array( "url" => "neurologi", "type" => 0 );
	$projectEntitiesReverse[ "neurologi" ] = "neurologi";
	$projectEntities[ "andrologi1" ] = array( "url" => "andrologi1", "type" => 1 );
	$projectEntitiesReverse[ "andrologi1" ] = "andrologi1";
	$projectEntities[ "ginekologi1" ] = array( "url" => "ginekologi1", "type" => 1 );
	$projectEntitiesReverse[ "ginekologi1" ] = "ginekologi1";
	$projectEntities[ "interna1" ] = array( "url" => "interna1", "type" => 1 );
	$projectEntitiesReverse[ "interna1" ] = "interna1";
	$projectEntities[ "jiwa1" ] = array( "url" => "jiwa1", "type" => 1 );
	$projectEntitiesReverse[ "jiwa1" ] = "jiwa1";
	$projectEntities[ "kulit1" ] = array( "url" => "kulit1", "type" => 1 );
	$projectEntitiesReverse[ "kulit1" ] = "kulit1";
	$projectEntities[ "bedah1" ] = array( "url" => "bedah1", "type" => 1 );
	$projectEntitiesReverse[ "bedah1" ] = "bedah1";
	$projectEntities[ "obstetri1" ] = array( "url" => "obstetri1", "type" => 1 );
	$projectEntitiesReverse[ "obstetri1" ] = "obstetri1";
	$projectEntities[ "paru1" ] = array( "url" => "paru1", "type" => 1 );
	$projectEntitiesReverse[ "paru1" ] = "paru1";
	$projectEntities[ "pediatri1" ] = array( "url" => "pediatri1", "type" => 1 );
	$projectEntitiesReverse[ "pediatri1" ] = "pediatri1";
	$projectEntities[ "tht1" ] = array( "url" => "tht1", "type" => 1 );
	$projectEntitiesReverse[ "tht1" ] = "tht1";
}
