...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("andrologi" == $this->chrt_array['tables'][0])
			return true;
		if("mata" == $this->chrt_array['tables'][0])
			return true;
		if("identitas_pasien" == $this->chrt_array['tables'][0])
			return true;
		if("icd10" == $this->chrt_array['tables'][0])
			return true;
		if("users" == $this->chrt_array['tables'][0])
			return true;
		if("jiwa" == $this->chrt_array['tables'][0])
			return true;
		if("tht" == $this->chrt_array['tables'][0])
			return true;
		if("rujukan" == $this->chrt_array['tables'][0])
			return true;
		if("resep" == $this->chrt_array['tables'][0])
			return true;
		if("ginekologi" == $this->chrt_array['tables'][0])
			return true;
		if("interna" == $this->chrt_array['tables'][0])
			return true;
		if("kulit" == $this->chrt_array['tables'][0])
			return true;
		if("pediatri" == $this->chrt_array['tables'][0])
			return true;
		if("resep_kacamata" == $this->chrt_array['tables'][0])
			return true;
		if("dosen" == $this->chrt_array['tables'][0])
			return true;
		if("catatan_kemajuan" == $this->chrt_array['tables'][0])
			return true;
		if("daftar_masalah" == $this->chrt_array['tables'][0])
			return true;
		if("daftar_masalah_interna" == $this->chrt_array['tables'][0])
			return true;
		if("daftar_masalah_pediatri" == $this->chrt_array['tables'][0])
			return true;
		if("rencana_permulaan" == $this->chrt_array['tables'][0])
			return true;
		if("mata" == $this->chrt_array['tables'][0])
			return true;
		if("paru" == $this->chrt_array['tables'][0])
			return true;
		if("obstetri" == $this->chrt_array['tables'][0])
			return true;
		if("bedah" == $this->chrt_array['tables'][0])
			return true;
		if("neurologi" == $this->chrt_array['tables'][0])
			return true;
		if("andrologi" == $this->chrt_array['tables'][0])
			return true;
		if("ginekologi" == $this->chrt_array['tables'][0])
