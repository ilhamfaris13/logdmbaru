...
require_once("include/daftar_masalah_pediatri_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "daftar_masalah_pediatri" );
