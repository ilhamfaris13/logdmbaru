...
h.designMode="on";loopCnt=0}}catch(e){if(loopCnt<maxLoops){setTimeout(function(){enableDesignMode(a,b,c);},100);loopCnt+=1}else{alert("Error enabling designMode.")}}}catch(e){if(debugMode)
alert(e)}}
