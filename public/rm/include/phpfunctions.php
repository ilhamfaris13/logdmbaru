...
{
	$body = prepareHttpBody( $parameters );
...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="andrologi" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="andrologi" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="jiwa" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="jiwa" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="tht" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="tht" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="resep" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="ginekologi" && $field=="id_mhs")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="ginekologi" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="interna" && $field=="id_mhs")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="interna" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="kulit" && $field=="id_mhs")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="kulit" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="pediatri" && $field=="id_mhs")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="pediatri" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="paru" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="paru" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="obstetri" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="obstetri" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="bedah" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="bedah" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="neurologi" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="neurologi" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="andrologi1" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="andrologi1" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="ginekologi1" && $field=="id_mhs")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="ginekologi1" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="interna1" && $field=="id_mhs")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="interna1" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="jiwa1" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="jiwa1" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="kulit1" && $field=="id_mhs")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="kulit1" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="bedah1" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="bedah1" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="obstetri1" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="obstetri1" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="paru1" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="paru1" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="pediatri1" && $field=="id_mhs")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="pediatri1" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="tht1" && $field=="id_pasien")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
				if($table=="tht1" && $field=="id_user")
	{
		$value = "<input type=\"hidden\" id=\"my_hidden_field\" name=\"my_hidden_field\" value=\"".$value."\" />";;
		return $value;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="andrologi" && $field=="VARIKOKEL")
	{
		return "Terlihat : \nTeraba : \nValsava : ";
	}
				if($table=="andrologi" && $field=="id_user")
	{
		return $_SESSION["id_user"];
				...
				if($table=="andrologi" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-ANDROLOGI/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="mata" && $field=="Riwayat_Penyakit_Sekarang")
	{
		return "Keluhan Utama : </br>Lokasi : </br>Onset :</br>Kronologi :</br>Faktor yang Memperberat/Memperingan :</br>Kualitas & Kuantitas Keluhan :</br>Keluhan Tambahan :";
	}
				if($table=="mata" && $field=="Id_User")
	{
		return $_SESSION["id_user"];
	}
				if($table=="mata" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-MATA/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="jiwa" && $field=="id_user")
	{
		return $_SESSION["id_user"];
	}
				if($table=="jiwa" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-JIWA/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="tht" && $field=="id_user")
	{
		return $_SESSION["id_user"];
	}
				if($table=="tht" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-THT/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="resep" && $field=="isi_resep")
	{
		return "R/";
	}
				if($table=="ginekologi" && $field=="id_mhs")
	{
		return $_SESSION["id_user"];
				...
				if($table=="ginekologi" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-GINEKOLOGI/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="interna" && $field=="id_mhs")
	{
		return $_SESSION["id_user"];
	}
				if($table=="interna" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-INTERNA/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="kulit" && $field=="id_mhs")
	{
		return $_SESSION["id_user"];
	}
				if($table=="kulit" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-KULIT/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="pediatri" && $field=="id_mhs")
	{
		return $_SESSION["id_user"];
	}
				if($table=="pediatri" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-PEDIATRI/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="mata1" && $field=="Riwayat_Penyakit_Sekarang")
	{
		return "Keluhan Utama : </br>Lokasi : </br>Onset :</br>Kronologi :</br>Faktor yang Memperberat/Memperingan :</br>Kualitas & Kuantitas Keluhan :</br>Keluhan Tambahan :";
	}
				if($table=="mata1" && $field=="Id_User")
	{
		return $_SESSION["id_user"];
	}
				if($table=="mata1" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-MATA/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="paru" && $field=="id_user")
	{
		return $_SESSION["id_user"];
				...
				if($table=="paru" && $field=="nomor_rm")
	{
		return $_SESSION["UserID"]."/DM/RM-PARU/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="obstetri" && $field=="id_user")
	{
		return $_SESSION["id_user"];
	}
				if($table=="obstetri" && $field=="nomor_rm")
	{
		return $_SESSION["UserID"]."/DM/RM-OBSTETRI/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="bedah" && $field=="id_user")
	{
		return $_SESSION["id_user"];
	}
				if($table=="bedah" && $field=="nomor_rm")
	{
		return $_SESSION["UserID"]."/DM/RM-THT/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="neurologi" && $field=="id_user")
	{
		return $_SESSION["id_user"];
				...
				if($table=="neurologi" && $field=="nomor_rm")
	{
		return $_SESSION["UserID"]."/DM/RM-NEURO/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="andrologi1" && $field=="VARIKOKEL")
	{
		return "Terlihat : \nTeraba : \nValsava : ";
	}
				if($table=="andrologi1" && $field=="id_user")
	{
		return $_SESSION["id_user"];
				...
				if($table=="andrologi1" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-ANDROLOGI/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="ginekologi1" && $field=="id_mhs")
	{
		return $_SESSION["id_user"];
				...
				if($table=="ginekologi1" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-GINEKOLOGI/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="interna1" && $field=="id_mhs")
	{
		return $_SESSION["id_user"];
				...
				if($table=="interna1" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-INTERNA/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="jiwa1" && $field=="id_user")
				...
				if($table=="kulit1" && $field=="id_mhs")
	{
		return $_SESSION["id_user"];
				...
				if($table=="kulit1" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-KULIT/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="bedah1" && $field=="id_user")
	{
		return $_SESSION["id_user"];
				...
				if($table=="bedah1" && $field=="nomor_rm")
	{
		return $_SESSION["UserID"]."/DM/RM-THT/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="obstetri1" && $field=="id_user")
	{
		return $_SESSION["id_user"];
				...
				if($table=="obstetri1" && $field=="nomor_rm")
	{
		return $_SESSION["UserID"]."/DM/RM-OBSTETRI/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="paru1" && $field=="id_user")
				...
				if($table=="pediatri1" && $field=="id_mhs")
	{
		return $_SESSION["id_user"];
				...
				if($table=="pediatri1" && $field=="Nomor_Rm")
	{
		return $_SESSION["UserID"]."/DM/RM-PEDIATRI/".strftime("%H%M%S.%Y.%m.%d");
	}
				if($table=="tht1" && $field=="id_user")
...
/*
function createOauthProvider( $clientId, $clientSecret, $urlAuth, $urlToken, $urlResourceOwnerDetails ) {
	
	require_once('vendor/autoload.php');
	$provider = new \League\OAuth2\Client\Provider\GenericProvider([
		'clientId'                => $clientId,    // The client ID assigned to you by the provider
		'clientSecret'            => $clientSecret,   // The client password assigned to you by the provider
		'redirectUri'             =>  projectURL().'oauthcallback.php',
		'urlAuthorize'            => $urlAuth,
...
/**
 * @return Array ( "bearer" => string, "token" => string)
 * "bearer" - access token to use in HTTP requests
 * "token" - new token info to save in storage
 */

/*
 function checkRefreshOauthToken( $token, $rconn ) {
	
	require_once('vendor/autoload.php');
	$provider = $rconn->getOauthProvider();
...
/*
function validateToken( $code, $rconn ) {
	try {
		$provider = $rconn->getOauthProvider();
		if( !$provider ) {
			return null;
