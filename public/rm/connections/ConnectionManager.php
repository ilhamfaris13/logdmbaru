...
class ConnectionManager
{
	...
	{
		return $this->byId( "newrm_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "newrm_at_localhost";
		$data["connName"] = "newrm2 at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;fkuht-2020;;newrm2;;1"; //currently unused

		$this->_connectionsIdByName["newrm2 at localhost"] = "newrm_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "root";
		$data["ODBCPWD"] = "fkuht-2020";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
...
;
		...
		$connectionsData["newrm_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["andrologi"] = "newrm_at_localhost";
		$connectionsIds["mata"] = "newrm_at_localhost";
		$connectionsIds["identitas_pasien"] = "newrm_at_localhost";
		$connectionsIds["icd10"] = "newrm_at_localhost";
		$connectionsIds["users"] = "newrm_at_localhost";
		$connectionsIds["jiwa"] = "newrm_at_localhost";
		$connectionsIds["tht"] = "newrm_at_localhost";
		$connectionsIds["rujukan"] = "newrm_at_localhost";
		$connectionsIds["resep"] = "newrm_at_localhost";
		$connectionsIds["ginekologi"] = "newrm_at_localhost";
		$connectionsIds["interna"] = "newrm_at_localhost";
		$connectionsIds["kulit"] = "newrm_at_localhost";
		$connectionsIds["pediatri"] = "newrm_at_localhost";
		$connectionsIds["resep_kacamata"] = "newrm_at_localhost";
		$connectionsIds["dosen"] = "newrm_at_localhost";
		$connectionsIds["catatan_kemajuan"] = "newrm_at_localhost";
		$connectionsIds["daftar_masalah"] = "newrm_at_localhost";
		$connectionsIds["daftar_masalah_interna"] = "newrm_at_localhost";
		$connectionsIds["daftar_masalah_pediatri"] = "newrm_at_localhost";
		$connectionsIds["rencana_permulaan"] = "newrm_at_localhost";
		$connectionsIds["mata1"] = "newrm_at_localhost";
		$connectionsIds["paru"] = "newrm_at_localhost";
		$connectionsIds["obstetri"] = "newrm_at_localhost";
		$connectionsIds["bedah"] = "newrm_at_localhost";
		$connectionsIds["neurologi"] = "newrm_at_localhost";
		$connectionsIds["andrologi1"] = "newrm_at_localhost";
		$connectionsIds["ginekologi1"] = "newrm_at_localhost";
		$connectionsIds["interna1"] = "newrm_at_localhost";
		$connectionsIds["jiwa1"] = "newrm_at_localhost";
		$connectionsIds["kulit1"] = "newrm_at_localhost";
		$connectionsIds["bedah1"] = "newrm_at_localhost";
		$connectionsIds["obstetri1"] = "newrm_at_localhost";
		$connectionsIds["paru1"] = "newrm_at_localhost";
		$connectionsIds["pediatri1"] = "newrm_at_localhost";
		$connectionsIds["tht1"] = "newrm_at_localhost";
