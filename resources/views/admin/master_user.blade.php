            ...
            <table id="tabel1" class="table table-bordered table-hover">
                ...
                <tbody>
                  @foreach($user2 as $key => $log)
                    ...
                    <a class="btn btn-warning btn-sm" href="admin/edit/{{$log->id}}" target="_blank"><i class="far fa-edit"></i></a>
                   <a href="/user/{{$log->id}}" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
