  ...
  <div class="col-6 col-md-6">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-body">
            <form id="edit-form" method="POST" action="<?php echo e(route('sinkron.create')); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <form id="edit-form" method="POST" action="<?php echo e(route('sinkron.create_dosen')); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <form id="edit-form" method="POST" action="<?php echo e(route('sinkron.resetpwd')); ?>">
                        <?php echo csrf_field(); ?>
            
              <div class="form-group">
              <input style="background-color: #4EB1BA; color: black" class="btn btn-small btn-success" type="submit" value="Reset Semua Password" />
             </div>
            </div>               
        </form>
            </div>
