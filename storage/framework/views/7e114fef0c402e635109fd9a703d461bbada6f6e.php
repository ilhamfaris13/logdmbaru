...
<div class="container-fluid">
   ...
   <!-- COL 2 -->
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Daftar Nilai DM Kulit</h3>
        </div>
     <div class="card-body">
     	<div class="row">
     	<div class="col-6 col-md-6">
     		<form method="get" action="/nilaikulit/filter" enctype="multipart/form-data">
  ...
  <!-- COL 2 -->
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Daftar Nilai DM Kulit <?php echo e($getKel); ?></h3>
        </div>
            <div class="card-body">
      ...
      <div class="modal-dialog" role="document">
        <form method="post" action="/pnilai/import_nilai_kulit" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logdmbaru\resources\views/nstase/nilai_kulit.blade.php ENDPATH**/ ?>