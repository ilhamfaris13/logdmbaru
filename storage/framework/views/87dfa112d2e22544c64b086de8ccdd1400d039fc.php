...
<div class="wrapper">
            ...
            <a href="#" class="nav-link">
              ...
              <p>
                ...
                <ul class="nav nav-treeview" style="display: none;">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(url('/masteruser')); ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>User</p>
                    </a>
                  </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="http://hangtuah.ac.id">Fakultas Kedokteran | Universitas Hang Tuah Surabaya</a>.</strong> All rights
    reserved.
  </footer>
...
<?php /**PATH C:\xampp\htdocs\log_dm\logdm\resources\views/admin/app.blade.php ENDPATH**/ ?>