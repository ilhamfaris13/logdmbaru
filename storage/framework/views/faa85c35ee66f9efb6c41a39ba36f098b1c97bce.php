               ...
               saveButton.addEventListener('click', function (event) {
                ...
                $.ajax({
                  ...
                  success: function(response){
                    window.location.href = "<?php echo e(url('/prolonged')); ?>";
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\log_dm\logdm\resources\views/prolonged/index.blade.php ENDPATH**/ ?>