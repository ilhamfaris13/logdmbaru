          ...
          <div class="col-12">
            <div class="card">
              ...
              <?php if( Auth::user()->level == "dm"): ?>
                  <a href="<?php echo e(url('/create_kegiatan')); ?>" class="btn btn-success" > Buat Baru</a>
                  <?php else: ?>
                  <?php endif; ?>
            ...
            <!--kiri-->
              ...
              <div class="widget-user-header ">
                <div class="widget-user-image">
                  <img class="img-circle elevation-2" src="/upload/wait.png" alt="User Avatar">
                </div>
                </div>
                <!-- /.widget-user-image -->
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/blog/resources/views/signaturepad.blade.php ENDPATH**/ ?>