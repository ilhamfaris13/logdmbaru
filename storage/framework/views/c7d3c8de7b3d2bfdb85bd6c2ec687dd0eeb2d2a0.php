    ...
    $.ajaxSetup({
            ...
            var canvas = document.getElementById('signature-pad');
               ...
               saveButton.addEventListener('click', function (event) {
                ...
                $.ajax({
                  url: "<?php echo e(url('/bimbingan/post')); ?>",
                  method: 'post',
                  data: {
                  ...
                  success: function(response){
                    window.location.href = "<?php echo e(url('/bimbingan')); ?>";
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\log_dm\logdm\resources\views//bimbingan/index.blade.php ENDPATH**/ ?>