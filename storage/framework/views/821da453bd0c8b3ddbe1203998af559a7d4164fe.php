...
<div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="edit-modal-label" aria-hidden="true">
      ...
      <div class="alert alert-success  alert-dismissible">
            ...
            <!--kiri-->
              ...
              <!-- /description -->
               <!-- description -->
               <div class="form-group">
                <label class="col-form-label" data-nilai="nilai" for="modal-input-nilai">Nilai</label>
                <input type="number"  name="nilai" class="form-control" id="modal-input-nilai" step="any" >
              </div>
              <!-- /description -->
            </div>
              </div>
  ...
  */
  $('#edit-modal').on('show.bs.modal', function() {
   ...
   // var row1 = el.closest(".data-nilai");
    ...
    //var nilai = row.children(".nilai").text();
    ...
    $.ajaxSetup({
            ...
            var canvas = document.getElementById('signature-pad');
               ...
               saveButton.addEventListener('click', function (event) {
                ...
                $.ajax({
                  url: "<?php echo e(url('/responsi/post')); ?>",
                  method: 'post',
                  data: {
                    
                     signature: signaturePad.toDataURL('image/png'),
                     id:id,
                     nilai:$('#modal-input-nilai').val(),
                  },
                  success: function(response){
                    window.location.href = "<?php echo e(url('/responsi')); ?>";
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\log_dm\logdm\resources\views//penilaian/responsi.blade.php ENDPATH**/ ?>