     ...
     <div class="card-body">
     	...
     	<div class="col-6 col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
            <label class="col-form-label" for="modal-input-nama">Stase </label>
            <select name="kelompok" class="form-control" id="kelompok">
              <option value="" disabled selected>Pilih</option>
              <?php $__currentLoopData = $stase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($log->id); ?>"><?php echo e($log->stase); ?></option>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logdmbaru\resources\views/Penilaian/nilai_stase.blade.php ENDPATH**/ ?>