  ...
  <div class="row">
    ...
    <div class="col-12 col-md-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
        <form method="POST" action="<?php echo e(route('atitude.create')); ?>" >
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\log_dm\logdm\resources\views/penilaian/atitude.blade.php ENDPATH**/ ?>